...
local function put_func(_,stack)
	...
	--	return false
	--end
	if gardening_tools[stack:get_name()] then
		return false
	end
	return true;
end
local function take_func(villager,stack)
	...
	--	end
	--end
	if gardening_tools[item_name] then
		local inv = villager:get_inventory()
		local itemstack = ItemStack(item_name)
		itemstack:set_count(gardening_tools[item_name])
		if (not inv:contains_item("main", itemstack)) then
			return true
		end
	end
